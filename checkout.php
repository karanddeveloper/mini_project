   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='welcome.php' class='btn'>continue shopping</a>
         </div>
      </div>
      ";
   }
...
<style>
     body{
			background-image: linear-gradient(#b87df9,#00bfff);
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      ?>
      <span class="grand-total"> grand total : <i class="fa-solid fa-indian-rupee-sign"></i><?= $grand_total; ?>/- </span>
   </div>
