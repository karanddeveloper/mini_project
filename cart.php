...
<?php define("imgpath","http://localhost/code/img/") ?>
...
<section class="shopping-cart">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            <td><img src="<?php echo imgpath.$fetch_cart['image'] ?>" height="100" width="120" alt=""></td>
            ...
            <td><i class="fa-solid fa-indian-rupee-sign"></i><?php echo $sub_total = ((int)$fetch_cart['price'] * (int)$fetch_cart['quantity']); ?>/-</td>
